    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='agendamentos', to='services.services')),
            ],
            options={
                'ordering': ['data', 'horario'],
                'unique_together': {('services', 'data', 'horario')},
            },
        ),
    ]
